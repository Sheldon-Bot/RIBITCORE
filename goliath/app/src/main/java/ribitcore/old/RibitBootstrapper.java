package ribitcore.old;

import com.diozero.util.SleepUtil;
import org.checkerframework.checker.nullness.qual.NonNull;
import processing.core.PApplet;
import ribitcore.old.display.DisplayApplet;
import ribitcore.old.input.InputClient;
...
public class RibitBootstrapper {
    ...
    public void start() {
        ...
        new Thread(() -> {
            PApplet.runSketch(new String[]{"DisplayApplet"}, new DisplayApplet(motorController));
        }).start();
    }
